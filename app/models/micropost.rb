...
class Micropost < ActiveRecord::Base
  ...
  attr_accessible :title, :content, :user_id, :gift, :module_id, :deadline, :is_anonymous, :status, :comments_attributes, :module_code, :click_count, :helper_id, :is_happy, :is_online
  belongs_to :user
